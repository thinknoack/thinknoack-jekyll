...
$( document ).ready(function() {
    ...
    $('#html-chart').waypoint(function(direction) {
     ...
     $('#css-chart').waypoint(function(direction) {
      ...
      $('#js-chart').waypoint(function(direction) {
       ...
       $('#design-chart').waypoint(function(direction) {
        ...
        $('#cms-chart').waypoint(function(direction) {
    ...
    $('#life-chart').waypoint(function(direction) {
...
function boxRollovers(){
    ...
    $selector.on("mouseleave",function(){
        ...
        oLayer.css({"transform":"perspective(1500px) translateZ(0) rotateX(0deg) rotateY(0deg)","transition":"all 150ms linear 0s","-webkit-transition":"all 150ms linear 0s"});
        oLayer.find("strong").css({"transform":"perspective(1500px) translateZ(0) rotateX(0deg) rotateY(0deg)","transition":"all 150ms linear 0s","-webkit-transition":"all 150ms linear 0s"});
    });
}

function updateView(oLayer){
    oLayer.css({"transform":"perspective(1500px) translateZ(" + Z + "px) rotateX(" + XAngle + "deg) rotateY(" + YAngle + "deg)","transition":"none","-webkit-transition":"none"});
    oLayer.find("strong").css({"transform":"perspective(1500px) translateZ(" + Z + "px) rotateX(" + (XAngle / 0.66) + "deg) rotateY(" + (YAngle / 0.66) + "deg)","transition":"none","-webkit-transition":"none"});
}
